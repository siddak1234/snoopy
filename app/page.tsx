...
export default function Home() {
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <RevealOnScroll>
        <section>
          <h2 className="mb-4 text-xl font-semibold sm:text-2xl">Industries</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            <article className="interactive-card bubble p-5 sm:p-6">
              ...
              <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
                Intake, documentation, and follow-up workflows with clear
                controls.
              </p>
              <Link
                href="/solutions/healthcare"
                className="mt-4 inline-flex text-sm font-semibold text-[var(--link)] underline underline-offset-4"
              >
      ...
      <RevealOnScroll>
        <section className="bubble-soft p-6 sm:p-7">
          ...
          <p className="mt-3 max-w-xl text-[var(--muted)]">
            Tell us which manual process is slowing your team. We will map a
