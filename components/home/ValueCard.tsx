...
export default function ValueCard({ title, description, icon }: ValueCardProps) {
  return (
    <article
      tabIndex={0}
      className="interactive-card bubble group p-5 focus-visible:-translate-y-1 focus-visible:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] sm:p-6"
    >
