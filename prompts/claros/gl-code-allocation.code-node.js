// Build Vertex AI GL Classification Request
// Place between "Group Line Items" and HTTP Request node
...
// (This is your "System Message" from the Gemini node)
// ═══════════════════════════════════════════
const systemMessage = `You are a highly accurate accounting classification model.
...
Final objective:
Your goal is maximum classification accuracy, consistency, and auditability.
Always preserve broad accounting coverage while following the exact GL list and any deterministic instructions provided in the user message.`;


// ═══════════════════════════════════════════
// PASTE YOUR USER PROMPT BETWEEN THE BACKTICKS BELOW
// (This is your "Prompt" / "Messages" from the Gemini node)
//
...
Within each category, always classify to a CHILD code.
